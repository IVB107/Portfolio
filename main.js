document.addEventListener("DOMContentLoaded", (event) => {
  ...
  // };
  const home = {
    subtitles: ["furthering my education.", "photography and design.", "music and my vinyl collection.", "travel & exploring new places.", "avocado.", "camping, hiking & rock climbing."],
    sub: 1,
    fadeSubtitle: ()=>{
      $("#sub").css({"opacity": "0"});
      setTimeout(()=>{
